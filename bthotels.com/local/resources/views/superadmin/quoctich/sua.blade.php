    ...
    <div class="row" >
      ...
      <div class="col-lg-11 col-center-block" style="padding-bottom:25px">
        <div class="form-group">
          <a href="superadmin/quoctich/danhsach"><button class="btn btn-primary"><img width="25px;" src="img/ic_back.png"/> Quay lại danh sách</button></a>
        </div>


        <form id="form_update" action="{{ URL::to('superadmin/quoctich/sua')}}/{{$quoctich->id_qt}}" method="POST" enctype="multipart/form-data">
          <input type="hidden" name="_token" value="{{ csrf_token() }}">
          <div class="form-group">
            <label>Tên quốc tịch</label>
            <input class="form-control" name="Ten" value="{{$quoctich->ten}}"  placeholder="Tên quốc tịch"/>
          </div>
