 ...
 <!-- Wrapper for slides --><center>
  <div class="carousel-inner" role="listbox">
   ...
   <div class="item active">
     <img src="{{ asset('img/hotel1.jpg') }}" class="img-rounded" alt="Chania" width="1000px" height="300px">
   </div>

   <div class="item">
     <img src="{{ asset('img/hotel2.jpg') }}" class="img-rounded" alt="Chania" width="1000px" height="300px">
   </div>

   <div class="item">
     <img src="{{ asset('img/hotel3.jpg') }}" class="img-rounded" alt="Chania" width="1000px" height="300px">
   </div>

   <div class="item">
     <img src="{{ asset('img/hotel4.jpg') }}" class="img-rounded" alt="Chania" width="1000px" height="300px">
   </div>
